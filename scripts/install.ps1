...
#
# Usage:
#   irm https://raw.githubusercontent.com/dfrer/hermes-agent/main/scripts/install.ps1 | iex
#
...
$RepoUrlSsh = "git@github.com:dfrer/hermes-agent.git"
$RepoUrlHttps = "https://github.com/dfrer/hermes-agent.git"
$PythonVersion = "3.11"
$NodeVersion = "22"
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/dfrer/hermes-agent/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
